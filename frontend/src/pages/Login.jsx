...
function Login() {
  ...
  const handleEmailLogin = async (e) => {
    ...
    if (!supabase) {
      alert(
        "Supabase is not initialized. Please check your frontend/.env file.",
      );
      return;
    }
    try {
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-2xl border border-zinc-200 py-3 text-sm font-semibold text-zinc-800 transition hover:border-black hover:bg-zinc-50"
                >
                  <FcGoogle size={22} />
