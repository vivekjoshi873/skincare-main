  ...
  const products = [
    {
      ...
      price: 1200,
      image: curlyHair,
      hoverImage: hoverCurlyHair,
      quantity: 1,
    },
    {
      id: "2",
      name: "Suncream SPF 50 - 50ml",
      price: 1140,
      image: suncreen,
      hoverImage: suncreamHover,
      quantity: 1,
    },
    {
      id: "3",
      ...
      price: 895,
      image: tanningCream,
      hoverImage: tanningCreamHover,
      quantity: 1,
    },
    {
      id: "4",
      name: "Acne Prone Skin Cream",
      price: 1350,
      image: acneCream,
      hoverImage: acneCreamHover,
      quantity: 1,
    },
    {
      id: "5",
    ...
    {
      id: "8",
      name: "Tanning Routine",
      price: 3100,
      image: tanningDrop2,
      hoverImage: tanningDropHover,
      quantity: 1,
    },
    {
      id: "9",
      name: "Anti-aging Tanning Drops",
      price: 2980,
      image: tanningDrop3,
      hoverImage: tanningDrop3Hover,
      quantity: 1,
    },
  ];
  ...
  return (
    <>
      <div className="w-full overflow-x-hidden">
        <div className="overflow-x-hidden">
          <div className="w-full ">
            <div className="">
              <h1 className="md:text-5xl text-3xl m-9 md:m-12 w-[50%]">
                Together for healthy skin
              </h1>
              <div className="flex justify-between items-center mt-10">
                <span className="md:m-12 hidden md:block">
                  Popular products
                </span>
                <NavLink
                  to="/allproduct"
              ...
              <div className="relative w-full overflow-hidden">
                ...
                <div
                  ...
                  className="flex transition-transform duration-300 ease-in-out gap-4 overflow-x-auto md:overflow-x-hidden scroll-smooth w-full snap-x snap-mandatory"
                >
                  <div className="min-w-[calc(100%-32px)] md:min-w-[calc(25%-16px)] flex-shrink-0 bg-zinc-100 cursor-pointer group snap-center">
                    ...
                    <div className="text-base relative group">
                      <h5 className="bg-white tracking-widest font-medium text-sm">
                        {" "}
                        Curly Hair Routine <br />— ₹1200
                      </h5>
                      <button
                  ...
                  <div className="min-w-[calc(100%-32px)] md:min-w-[calc(25%-16px)] flex-shrink-0 bg-zinc-100 cursor-pointer group snap-center">
                    ...
                    <div className="text-base relative group">
                      <h5 className="bg-white tracking-widest font-medium text-sm">
                        {" "}
                        Acne Prone Skin Cream <br /> — ₹1350{" "}
                      </h5>
                      <button
                        onClick={(e) => handleAddToCart(e, products[3])}
                        className="absolute -top-14 right-2 bg-black text-white p-2 px-3 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-1 text-sm font-medium"
                      >
                        Add <IoMdAdd />
                      </button>
                  ...
                  <div className="w-[70%] md:w-1/4 flex-shrink-0 ... bg-zinc-100 cursor-pointer group snap-center">
                    ...
                    <div className="text-base relative group">
                      ...
                      <button
                        onClick={(e) => handleAddToCart(e, products[4])}
                        className="absolute -top-14 right-2 bg-black text-white p-2 px-3 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-1 text-sm font-medium"
                      >
                        Add <IoMdAdd />
                      </button>
                  ...
                  <div className="w-[70%] md:w-1/4 flex-shrink-0 ... bg-zinc-100 cursor-pointer group snap-center">
                    ...
                    <div className="text-base relative group">
                      ...
                      <button
                        onClick={(e) => handleAddToCart(e, products[5])}
                        className="absolute -top-14 right-2 bg-black text-white p-2 px-3 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-1 text-sm font-medium"
                      >
                        Add <IoMdAdd />
                      </button>
      ...
      <section className="my-12  ">
        <h1 className="text-3xl md:text-5xl w-[79%] md:w-[65%] mx-6 md:max-w-[65%] font-medium">
          Ray products are developed by pharmacist Hilde Nys. They contain only
          ingredients of natural origin with scientifically proven effects.
        </h1>
        <div className="flex gap-8 py-20">
          ...
          <div className=" md:w-[40%] grid grid-cols-2 md:flex md:flex-col gap-4 md:gap-6 md:m-6 m-2">
            <div className="bg-white cursor-pointer group">
              <div className="bg-zinc-100 h-[300px] md:h-[420px] flex flex-col">
                <div className="mx-5 mt-6 mb-2">
                  <h4 className="font-semibold">Face</h4>
                  <span className="text-gray-500 text-sm">32 products</span>
                </div>
                <div className="flex-1 flex items-center justify-center overflow-hidden">
                  <Link to="/allproduct" className="w-full h-full p-6">
                    <img
                      src={facewash}
                      alt="face Wash"
            ...
            <div className="bg-white cursor-pointer group">
              <div className="bg-zinc-100 h-[300px] md:h-[420px] flex flex-col">
                <div className="mx-5 mt-6 mb-2">
                  ...
                  <span className="text-gray-500 text-sm">20 products</span>
                </div>
                <div className="flex-1 flex items-center justify-center overflow-hidden">
                  <Link to="/allproduct" className="w-full h-full p-6">
                    <img
            ...
            <div className="bg-white cursor-pointer group">
              <div className="bg-zinc-100 h-[300px] md:h-[420px] flex flex-col">
                <div className="mx-5 mt-6 mb-2">
                  <h4 className="font-semibold">Hair Care</h4>
                  <span className="text-gray-500 text-sm">8 products</span>
                </div>
                <div className="flex-1 flex items-center justify-center overflow-hidden">
                  <Link to="/curly-hair" className="w-full h-full p-6">
                    <img
                      src={antiFrizz}
                      alt="anti frizz"
                      className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110"
            ...
            <div className="bg-white cursor-pointer group">
              <div className="bg-zinc-100 h-[300px] md:h-[420px] flex flex-col">
                <div className="mx-5 mt-6 mb-2">
                  <h4 className="font-semibold">Sun Care</h4>
                  <span className="text-gray-500 text-sm">12 products</span>
                </div>
                <div className="flex-1 flex items-center justify-center overflow-hidden">
                  <Link to="/suncream" className="w-full h-full p-6">
                    <img
                      src={faceBody}
                      alt="face body"
                      className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110"
              ...
              <div className="bg-white cursor-pointer">
                <div className="bg-zinc-100 h-[300px] md:h-[420px]">
                  <div className="mx-5 my-6 py-4 leading-tight">
                    <h1 className="md:text-2xl text-xl font-semibold font-sans md:w-[80%]">
                      Results that speak for themselves, with pharmaceutical
                      reliability.
                    </h1>
                  </div>
                  <li className="h-[300px] flex items-end pb-6 md:pb-0">
                    <Link to="/" className="w-full flex justify-start pl-7">
                      <Link
                        to="/"
                        className="font-semibold  items-center justify-center p-8 font-sans md:mb-12 hidden md:flex"
                      >
                        Shop here <GoArrowRight className="ml-1" />
                      </Link>
                    </Link>
                  </li>
                </div>
      ...
      <div className="max-w-full">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 p-6 order-2 md:order-1">
            <h1 className="text-3xl md:text-5xl font-medium mb-5 w-full md:w-[80%] leading-tight">
              Each ingredient is analyzed separately for potential
              endocrine-disrupting, carcinogenic, irritating, and
              pigment-altering health risks.
            </h1>
            <li className="list-none mt-4">
              ...
              >
                Show all products <GoArrowRight className="ml-1" />
              </Link>
            </li>
          </div>
        </div>
          ...
          <div className="w-full md:w-[40%] flex flex-col gap-8">
            <div className="w-full md:w-[90%] h-[500px] flex-shrink-0 bg-zinc-100 cursor-pointer group">
              ...
              <div className="text-base relative group">
                ...
                <button
                  onClick={(e) => handleAddToCart(e, products[6])}
                  className="absolute -top-12 right-2 bg-black text-white p-2 px-3 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-1 text-sm font-medium"
                >
                  Add <IoMdAdd />
                </button>
            ...
            <div className="w-full md:w-[90%] h-[500px] flex-shrink-0 bg-zinc-100 cursor-pointer group mt-6">
              ...
              <div className="text-base relative group">
                <h5 className="bg-white tracking-widest font-medium text-sm">
                  Tanning Routine— ₹3100
                </h5>
                <button
                  onClick={(e) => handleAddToCart(e, products[7])}
                  className="absolute -top-12 right-2 bg-black text-white p-2 px-3 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-1 text-sm font-medium"
                >
                  Add <IoMdAdd />
                </button>
            ...
            <div className="w-full md:w-[90%] h-[500px] flex-shrink-0 bg-zinc-100 cursor-pointer group mt-6">
              ...
              <div className="text-base relative group">
                <h5 className="bg-white tracking-widest font-medium text-sm">
                  Anti-aging Tanning Drops —₹2980
                </h5>
                <button
                  onClick={(e) => handleAddToCart(e, products[8])}
                  className="absolute -top-12 right-2 bg-black text-white p-2 px-3 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center gap-1 text-sm font-medium"
                >
                  Add <IoMdAdd />
                </button>
      ...
      <div className="relative w-full overflow-hidden bg-zinc-100 pb-10">
        <div className="absolute top-1/2 left-4 transform -translate-y-1/2 z-10">
          <button
            onClick={slideLeftReview}
            className="bg-white p-2 rounded-full shadow-md md:block hidden"
          >
        ...
        >
            ...
            <div className="flex gap-4 m-5 h-full ">
              ...
              <div className="flex-1 relative w-full sm:w-[350px]">
                <h1 className="text-[16px] sm:text-[28px] font-semibold font-sans max-w-full sm:max-w-[350px] ">
                  Very satisfied with it. I dare to go out on the street more
                  confidently without makeup.
                </h1>
          ...
          <div className="min-w-[90%] sm:min-w-[45%] flex-shrink-0 bg-white h-96 flex flex-col gap-4 sm:ml-10 w-[20%]">
            <div className="flex gap-4 m-5 h-full">
              ...
              <div className="flex-1 relative w-full sm:w-[350px]">
                <h1 className="text-[16px] sm:text-[28px] font-semibold font-sans max-w-full sm:max-w-[350px] ">
                  The best sunscreen I've ever used! Lightweight and doesn't
                  leave a white cast.
                </h1>
                <div className="absolute bottom-0">
                  <p className="text-lg font-extralightbold">★★★★★</p>
      ...
      <div className="m-8 mt-20">
        <h3 className="text-base font-medium tracking-wide m-2">
          Ray stores (4)
        </h3>
        ...
        <div className="flex sm:flex-wrap gap-4 w-full overflow-x-auto scroll-smooth sm:overflow-x-hidden mt-5">
          ...
          <div className="min-w-[100%] h-[500px] md:h-[550px] md:w-[350px] flex-shrink-0 sm:min-w-0 sm:h-auto">
            <img
              ...
              className="w-full h-[75%] object-cover"
            />
            <h3 className="font-semibold font-sans tracking-wide">
              Ray Bruges
            </h3>
            <p className="text-gray-500 tracking-wide">
              Zuidzandstraat 4, Brugge
            </p>
          </div>
